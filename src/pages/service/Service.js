...
function Service() {
    ...
    useEffect(() => {
        const catagorylist = async () => {
            const catagorlis = await axios.get('http://localhost:3000/service')
    ...
    const subsave = async (event) => {
        ...
        if (edit) {
            const urlupdate = `http://localhost:3000/service/${editId}`
            ...
            const additems = await axios.post('http://localhost:3000/service', event)
            console.log(additems)
            //console.log(newitem)
    ...
    const del = async (id) => {
        alert(id)
        const delet = await axios.delete(`http://localhost:3000/service/${id}`);
        console.log(delet)
        setrus(new Date())
        Swal.fire(
            'Done!',
                                    ...
                                    <div class="form-row">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                />
                                                {
                                                    errors.name && <span className='text-danger'>faldan sogeli magac</span>
                                                }
                                            </div >
                                            <div class="form-group col-md-6">
