        ...
        rows: selis?.map(data => {
            data.action = (
                <div className="d-flex">
                    ...
                    <Link to ='/payment' onClick={() => ("")} className='btn btn-danger ms-2'><i className="ion ion-md- trash font-size-16" />payment</Link>
                                    ...
                                    <div class="form-row">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                />
                                                {
                                                    errors.name && <span className='text-danger'>faldan sogeli name</span>
                                                }
                                            </div >
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" class="form-control" id="inputAddress2" placeholder="Enter quanty"
                                                    {...register("age", {
                                                        required: true
                                                    })}
                                                />
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="date" class="form-control" id="inputAddress2" placeholder="Enter customerka"
                                                    {...register("date", {
                                                        required: true
                                                    })}
                                                />
                                                {
                                                    errors.date && <span className='text-danger'>faldan sogeli date</span>
                                                }
                                            </div >
                                        </div>
                                        {/* <div class="form-row">
